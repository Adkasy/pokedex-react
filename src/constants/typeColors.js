...
// nulis ulang `types?.[0]?.type?.name` tiap kali butuh warnanya. Ada 2
// varian: yang vivid (TYPE_COLORS, buat badge/accent) dan yang
// soft/pastel (CARD_COLORS, buat background gede) — lihat komen
// CARD_COLORS di atas kenapa dua-duanya perlu beda.
